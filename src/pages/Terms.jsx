  ...
  return (
    <section className="margin70 defaults">
      ...
      <p>
        ...
        carefully before using the My Strapi Shop website (the "service")
        operated by My Strapi Shop ("us", "we", or "our").
      </p><br />
      ...
      <p>
        ...
        address, payment information, and shipping information.
      </p>
      ...
      <p>
        <span className="bold">By email:</span> info@legedaarygemstone.com
      </p>
      <p>
        <span className="bold">By visiting this page on our website:</span>{" "}
        <Link
          className="footer-link"
          to="https://my-strapi-shop.techtaleyportfolio.com/contact"
        >
          https://my-strapi-shop.techtaleyportfolio.com/contact
        </Link>
      </p>
      <p>
        <span className="bold">Last updated:</span> February 27, 2024
      </p>
    </section>
  );
}
